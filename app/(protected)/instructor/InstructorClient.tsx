// ÔöÇÔöÇ Instructor dashboard ÔÇö app/instructor/page.tsx ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
'use client';
...
const SCENARIO_LABELS: Record<ScenarioType, { label: string; color: string; icon: string }> = {
  fire:      { label: 'FIRE ALARM',       color: '#ef4444', icon: '­ƒöÑ' },
  mob:       { label: 'MAN OVERBOARD',    color: '#f97316', icon: '­ƒåÿ' },
  collision: { label: 'COLLISION ALERT',  color: '#eab308', icon: 'ÔÜá´©Å' },
  custom:    { label: 'CUSTOM MESSAGE',   color: '#8b5cf6', icon: '­ƒôó' },
};
...
export default function InstructorPage() {
  ...
  // ÔöÇÔöÇ WebSocket ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
  ...
  useEffect(() => {
    ...
    return () => {
      cancelled = true;
      if (pingRef.current) clearInterval(pingRef.current);
      // Don't close the ws ÔÇö StrictMode will remount immediately and we want
      // to keep the same connection. The socket closes naturally on navigation.
    };
  }, []);

  // ÔöÇÔöÇ Actions ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
  ...
  // ÔöÇÔöÇ Derived ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', flex: 1, minHeight: 0 }}>
        ...
        {/* ÔöÇÔöÇ Left sidebar ÔÇö session + scenario controls ÔöÇÔöÇ */}
        <div style={{
          width:        '260px',
          flexShrink:   0,
          ...
          <div>
            ...
            {sessionCode ? (
              ...
              <div style={{ fontSize: '0.6rem', color: '#475569', letterSpacing: '0.15em' }}>
                {connected ? 'GeneratingÔÇª' : 'Waiting for connectionÔÇª'}
              </div>
            )}
          </div>
        ...
        {/* ÔöÇÔöÇ Main area ÔÇö student cards ÔöÇÔöÇ */}
        <div style={{ flex: 1, padding: '1.25rem', overflowY: 'auto' }}>
          ...
          {studentList.length === 0 ? (
            <div style={{
              ...
              <div style={{ fontSize: '3rem' }}>ÔÜô</div>
...
// ÔöÇÔöÇ Student card ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
